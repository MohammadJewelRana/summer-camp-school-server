...
//payment api
        ...
        // })
            ...
            console.log(payment.allClasses);
            

            // payment.courseNamesId.forEach(element => {
            //     // console.log(element); 
            // });
...
//------------------------------------------------
        ...
        app.patch('/classes/update/:id', async (req, res) => {
           ...
           console.log(id);
        //     const filter={_id: new ObjectId(id)};
        //     const updateAvailableSeat={
        //     $set:{
        //         available_seat:
        //     }
        //     }
        // const result=await  classesCollection.updateOne(filter,updateAvailableSeat);
        // res.send(result);  
